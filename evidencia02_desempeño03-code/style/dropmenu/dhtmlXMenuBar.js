 ...
 dhtmlXMenuBarObject.prototype._createPanel=function()
{
 ...
 div.innerHTML='<table cellpadding="0" border=0 cellspacing="0" class="'+this.topMenu.tableCSS+'" width="'+this.width+'" height="'+this.height+'"><tbody>'+
 '<tr>'+
 ...
 '<td></td>'+
 '<td style="display:none" align="right" class="'+this.topMenu.titleCSS+'"></td>'+
 '</tr></tbody></table>';
 ...
 if(id.tagName=="MenuItem")
{
 ...
 image_size=parseInt(image_size)||16;
