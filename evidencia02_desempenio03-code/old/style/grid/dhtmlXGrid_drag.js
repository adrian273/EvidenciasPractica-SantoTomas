...
// var newone=tree._attachChildNode(targetObject,treeNodeId,this.gridToTreeElement(targetObject.id,treeNodeId,gridRowId),"",img,img,img,"","",beforeNode);

 if (this.gridToTreeElement(targetObject.id,treeNodeId,gridRowId)) {
 	if (this.deleteRow(gridRowId));
 } 
