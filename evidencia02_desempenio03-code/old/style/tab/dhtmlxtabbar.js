...
function dhtmlXTabBar(parentObject,mode,height)
{
	this._isIE7s=((_isIE)&&window.XMLHttpRequest&&(document.compatMode != "BackCompat"));
	   ...
	   if (_isIE) this.preventIECashing(true);
        ...
        this._tbst="win_text";
        this._styles={
            winDflt:["blue/r_p.png","blue/c_p.png","blue/l_p.png","blue/r_a.png","blue/c_a.png","blue/l_a.png","blue/c_p.png",3,3,6,"#F4F3EE","#F0F8FF",false],
...
dhx_blue:["blue/r_p.png","blue/c_p.png","blue/l_p.png","blue/r_a.png","blue/c_a.png","blue/l_a.png","blue/c_p.png",2,2,4,false,false,"transparent"],
...
/*return*/              return; 
                    break;
                case "iframes":
                case "iframes-refresh":
                case "iframes-refresh-always":
...
//#href_support:24052006{
        if (this._hrfmode)
           switch(this._hrfmode){
				...
				case "iframes-refresh":
				/*
					if ((this._hrfmode=="iframes-refresh"))
						{
							var ifrm = this._content[tab.idd].childNodes[0];
				...
				*/
					if ((this._hrfmode=="iframes-refresh")&&(!this._content[tab.idd]._loaded))
						{
							...
							var ifrm = this._content[tab.idd].childNodes[0];
				            ifrm = (ifrm.contentWindow) ? ifrm.contentWindow : (ifrm.contentDocument.document) ? ifrm.contentDocument.document : ifrm.contentDocument;
							if (ifrm.loadGrid) ifrm.loadGrid();
