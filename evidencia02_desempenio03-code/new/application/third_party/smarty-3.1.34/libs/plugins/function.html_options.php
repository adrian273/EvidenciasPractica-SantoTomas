...
function smarty_function_html_options($params, Smarty_Internal_Template $template)
{
    ...
    $class = null;
    $extra = '';
    $has_firts_option = true; // this is a custom variable for home healt soft
    ...
    foreach ($params as $_key => $_val) {
        switch ($_key) {
            ...
            case 'options':
                $options = (array)$_val;
                break;
            // this is a custom function for home healt soft
            case 'has_firts_option':
                $$_key = (boolean) $_val;
                break;
            case 'first_option':
                $$_key = (string) $_val;
    ...
    if (!empty($name)) {
        ...
        // this is a custom function for home healt soft
        $first_option = ($has_firts_option == true ? '<option value="">' . $first_option . '</option>' : '');
